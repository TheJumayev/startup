...
const Duty = () => {
      ...
      const studentsWithLessons = await Promise.all(
        studentsList.map(async (item) => {
          ...
          try {
            ...
            console.log("🟢 TALABA:", student.fullName);
            console.log("📚 FANLAR:", res.data);
  ...
  return (
    <div className="mx-auto max-w-7xl p-6">
      <ToastContainer />
      <Breadcrumbs items={[{ label: "Guruhlar", to: "/admin/online-group" }]} />
                    ...
                    {filteredStudents.map((student, index) => (
                      ...
                      >
                        <td
                          ...
                          onClick={() =>
                            navigate(
                              `/admin/online-group/student/${student.student.id}`,
                              {
                ...
                {filteredGroups.map(
                  (
                    ...
                    <tr
                      ...
                      onClick={() =>
                        navigate(`/admin/curriculum-subject/${g.id}`)
                      }
                    >
                      <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">
                        {i + 1}
