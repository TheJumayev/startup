...
public class BankerController {
    ...
    @PostMapping
    public HttpEntity<?>banker(@RequestBody UserSave userSave) {
        ...
        Role adminRole = roleRepo.findByName(UserRoles.ROLE_BUGALTER);
        if (adminRole == null) {
    ...
    public HttpEntity<?> getAdmins() {
        List<User> allAdminsByRole = userRepo.findAllBankerByRole();
