                          ...
                          <div>
                            <button
                              onClick={() => {
                                ...
                                navigate(
                                  `/superadmin/exam-mustaqil/student/test-view/${row.finalExamStudentId}`
                                );
                              }}
                      ...
                      <td className="px-6 py-4">
                        {row.ball !== undefined && row.ball !== null ? (
                          ...
                          <button
                            ...
                            className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 px-4 py-2 text-sm font-medium text-white shadow transition hover:from-blue-600 hover:to-blue-700"
                          >
                            <PencilIcon className="h-4 w-4" />
                            Ball berish
                          </button>
