...
const LS_KEY = "office_final_exam_filters";
...
function EditFinalExamOffice() {
  ...
  // ─────────────────────────────────────────
  // CLIENT-SIDE: search + date — real-time
  // ─────────────────────────────────────────
    ...
    async (filters) => {
      ...
      try {
        ...
        const res = await ApiCall(
          `/api/v1/final-exam/filter?semesterCode=${semesterCode}&groupId=${groupId}`,
          "GET"
        );
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-6 rounded-2xl border-l-4 border-blue-600 bg-white p-6 shadow-lg">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <button
                onClick={() => navigate("/office/final-exam/create")}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-3 font-semibold text-white shadow-md transition-all hover:from-blue-700 hover:to-blue-800 hover:shadow-lg lg:w-auto"
              >
                <svg
                  className="h-5 w-5"
                  fill="none"
                      ...
                      >
                        ...
                        <td className="whitespace-nowrap p-4">
                          <span
                            onClick={() =>
                              navigate(
                                `/office/final-exam/hisobot/${exam.id}`,
                                {
                                  state: {
                          ...
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <button
                              onClick={() => {
                                ...
                                navigate(`/office/final-exam/edit/${exam.id}`);
                              }}
                            ...
                            <button
                              ...
                              onClick={async () => {
                                ...
                                navigate(
                                  `/office/final-exam/students/${exam.id}`
                                );
                              }}
                            ...
                            <button
                              ...
                              className="flex items-center gap-2 rounded-lg bg-red-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-red-600 hover:shadow-md"
                            >
                              <svg
                                className="h-4 w-4"
                                fill="none"
                      ...
                      <div className="flex gap-2 pt-2">
                        ...
                        <button
                          ...
                          onClick={async () => {
                            ...
                            setNavigateLoading(true);
                            await updateStatus(exam.id);
                            navigate(`/office/final-exam/students/${exam.id}`);
                          }}
...
export default EditFinalExamOffice;
