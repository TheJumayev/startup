...
function FinalExamEdit() {
  ...
  const validateForm = () => {
    ...
    if (selectedSubject?.test_count < 50) {
      alert(
        `⚠️ Ushbu fan uchun kamida 100 ta test bo‘lishi shart! Hozirgi testlar soni: ${selectedSubject?.test_count}`
      );
      return false;
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      navigate("/superadmin/final-exam");
    } catch (err) {
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <button
                onClick={() => {
                  ...
                  navigate(
                    `/superadmin/test-upload/${selectedSubject.subject.id}`
                  );
                }}
          ...
          <div className="mt-12 flex flex-col items-end justify-between gap-4 border-t border-gray-200 pt-6 sm:flex-row">
            ...
            <div className="flex flex-col justify-end gap-4 sm:flex-row">
              ...
              <button
                ...
                disabled={loading || selectedSubject?.test_count < 50}
