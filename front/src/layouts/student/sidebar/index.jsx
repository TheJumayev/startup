...
const SidebarModern = ({ open, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed left-0 top-0 z-40 flex h-screen w-64 transform flex-col overflow-y-auto border-r border-gray-200 bg-white shadow-xl transition-transform duration-300 dark:border-gray-700 dark:bg-gray-900 ${
      ...
      >
        ...
        {studentInfo?.fullName && (
          <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-green-400 to-blue-500">
        ...
        {/* Menu Section */}
        <div className="flex-1 space-y-2 px-2 py-6">
