...
@Builder
@Entity
@Table(name = "final_exam_student")
public class FinalExamStudent {
    @Id
    ...
    @ElementCollection
    @CollectionTable(
            name = "final_exam_student_permission_texts",
            joinColumns = @JoinColumn(name = "final_exam_student_id")
    )
    @Column(name = "permission_text")
    private List<String> permissionTextList;
