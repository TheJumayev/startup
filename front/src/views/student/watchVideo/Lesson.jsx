...
const Lesson = () => {
  ...
  if (isFromDarsKurish && !hasPdf) {
    return (
      <div className="p-6">
        <div className="rounded border border-gray-300 p-4 text-center text-gray-800 shadow">
          ❌ Ushbu dars foydalanuvchiga mumkin fayl yo‘q. <br />
        ...
        <div className="mt-6 flex justify-center">
          <button
            ...
            className="rounded bg-blue-600 px-8 py-2 font-semibold text-white transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            Bosh sahifaga
          </button>
        </div>
