...
const LS_KEY = "tc_final_exam_filters";
...
// ─────────────────────────────────────────
// MAIN COMPONENT  (test-center roli)
// ─────────────────────────────────────────
function EditFinalExamTestCenter() {
  ...
  // ─────────────────────────────────────────
  // CLIENT-SIDE: search (real-time) + sana
  // ─────────────────────────────────────────
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-6 rounded-2xl border-l-4 border-blue-600 bg-white p-6 shadow-lg">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <button
                onClick={() => navigate("/test-center/final-exam/create")}
                ...
                <div className="relative md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      // ⚡ Real-time — serverga so'rov yuborilmaydi
                      ...
                      >
                        ...
                        <td className="whitespace-nowrap p-4">
                          <span
                            onClick={() =>
                              navigate(
                                `/test-center/final-exam/hisobot/${exam.id}`,
                                {
                                  state: {
                          ...
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <button
                              onClick={() => {
                                ...
                                navigate(
                                  `/test-center/final-exam/edit/${exam.id}`
                                );
                              }}
                            ...
                            <button
                              ...
                              onClick={async () => {
                                ...
                                navigate(
                                  `/test-center/final-exam/students/${exam.id}`
                                );
                              }}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2 pt-2">
                        <button
                          onClick={() => {
                            setNavigateLoading(true);
                            navigate(`/test-center/final-exam/edit/${exam.id}`);
                          }}
...
export default EditFinalExamTestCenter;
