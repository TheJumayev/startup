...
function SuperadminFinalExamEdit() {
    ...
    const getMaxBall = (st) => {
        if (st?.finalExam?.isAmaliyot === true) {
            return 100;
        }
        return 50;
    };
    ...
    const updateBall = async (finalExamStudentId, ball) => {
        ...
        const st = students.find(s => s.id === finalExamStudentId);
        const maxBall = getMaxBall(st);
        const intBall = parseInt(ball);
        ...
        <div className="min-h-screen  py-8">
                                        ...
                                        <td
                                            ...
                                            onClick={() => {
                                                ...
                                                if (
                                                    ...
                                                    navigate(`/office/final-exam/students/tests/${st.id}`);
                                                }
                                            }}
                                        >
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {st.ball !== null && st.ball !== undefined ? (
                                                        <button
                                                            ...
                                                            className="px-3 py-1 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg font-semibold"
                                                        >
                                                            {st.ball} ball
                                                        </button>
                                                    ) : (
            ...
            {ballModal && (
                <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-2xl shadow-2xl max-w-md w-full border-t-4 border-blue-600 mx-4">
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    if (val < 0 || val > maxBall) {
                                        toast.error(`❌ Ball 0 dan ${maxBall} gacha bo'lishi kerak!`);
                                        return;
                                    }
                                    setNewBall(val);
                                }}
