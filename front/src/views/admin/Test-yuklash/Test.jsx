...
function Test() {
  ...
  const handleSubmitTest = async () => {
    ...
    try {
      await ApiCall(
        `/api/v1/test-curriculum-subject/test-form/${curriculumSubjectId}`,
        "POST",
  ...
  const deleteTest = async (curriculumSubjectId) => {
    try {
      await ApiCall(`/api/v1/test-curriculum-subject/${curriculumSubjectId}`, "DELETE");
  ...
  return (
    <div className="p-6">
      <Breadcrumbs
        items={[{ label: "Test yuklanadigan fanlar", to: "/admin/curriculums-subject" }]}
      />
          ...
          <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white">
            ...
            <div className="p-6">
              ...
              <p className="mb-2 text-sm text-gray-600">
                ...
                <b> # </b> belgisi bilan boshlanishi kerak. <br /><b>Misol:</b>
              </p>
              <textarea
                value={testContent}
